...
class image_converter:
  ...
  def callback(self,data):
    ...
    with open('/home/jetbot/catkin_ws/src/jetbot_pro/scripts/yolov3/yolov3.txt', 'r') as f:
        self.classes = [line.strip() for line in f.readlines()]
    self.COLORS = np.random.uniform(0, 255, size=(len(self.classes), 3))

    start = datetime.datetime.now()
    net = cv.dnn.readNet('/home/jetbot/catkin_ws/src/jetbot_pro/scripts/yolov3/yolov3.weights', '/home/jetbot/catkin_ws/src/jetbot_pro/scripts/yolov3/yolov3.cfg')
    ...
    for out in outs:
        for detection in out:
            ...
            if confidence > 0.5:
                ...
                if self.classes[class_id] == "chair" or self.classes[class_id] == "backpack":
